...
import com.monofire.newsapp.util.Constants
import com.monofire.newsapp.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchNewsFragment : Fragment(R.layout.fragment_search_news) {
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if (shouldPagenate) {
                viewModel.searchNews(editSearch.text.toString())
                isScrolling = false
            } else {
                rc_search.setPadding(0, 0, 0, 0)
