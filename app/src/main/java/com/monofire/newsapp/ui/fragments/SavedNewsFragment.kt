...
class SavedNewsFragment : Fragment(R.layout.fragment_saved_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val itemItemTouchHelperCallback = object : ItemTouchHelper.SimpleCallback(
        ...
        ItemTouchHelper(itemItemTouchHelperCallback).apply {
            attachToRecyclerView(rcSavedNews)
        }
